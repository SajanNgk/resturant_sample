...
import 'package:hyperce/screens/product/view_product_page.dart';
...
class _SearchPageState extends State<SearchPage>
  ...
  List<ProductModel> products = [
    ProductModel(
      id: '20',
      preview: Asset(source: 'assets/headphones_2.png'),
      ...
      price: ProductVariantDetail(priceWithTax: 1033),
      rating: CustomFields(reviewCount: 5),
    ),
    ProductModel(
      id: '22',
      preview: Asset(source: 'assets/headphones_3.png'),
    ...
    ProductModel(
      id: '23',
      preview: Asset(source: 'assets/headphones.png'),
      name: 'Blackzy PRO hedphones M003',
      description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor ut labore et dolore magna aliqua. Nec nam aliquam sem et tortor consequat id porta nibh. Orci porta non pulvinar neque laoreet suspendisse. Id nibh tortor id aliquet. Dui sapien eget mi proin. Viverra vitae congue eu consequat ac felis donec. Etiam dignissim diam quis enim lobortis scelerisque fermentum dui faucibus. Vulputate mi sit amet mauris commodo quis imperdiet. Vel fringilla est ullamcorper eget nulla facilisi etiam dignissim. Sit amet cursus sit amet dictum sit amet justo. Mattis pellentesque id nibh tortor. Sed blandit libero volutpat sed cras ornare arcu dui. Fermentum et sollicitudin ac orci phasellus. Ipsum nunc aliquet bibendum enim facilisis gravida. Viverra suspendisse potenti nullam ac tortor. Dapibus ultrices in iaculis nunc sed. Nisi porta lorem mollis aliquam ut porttitor leo a. Phasellus egestas tellus rutrum tellus pellentesque. Et malesuada fames ac turpis egestas maecenas pharetra convallis. Commodo ullamcorper a lacus vestibulum sed arcu non odio. Urna id volutpat lacus laoreet non curabitur gravida arcu ac. Eros in cursus turpis massa. Eget mauris pharetra et ultrices neque.',
      price: ProductVariantDetail(priceWithTax: 133),
      rating: CustomFields(reviewCount: 5),
    ),
  ];
